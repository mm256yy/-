	...
	<view class="content" :style="{backgroundColor: template.color.back_color}">
				...
				<view class="goods_box">
					<view class="goods" v-for="(item, index) in orderDetail.orderItemList" :key="item.id">
						...
						<view class="right">
							...
							<view class="goodsSpecification" v-if="item.goodsSpecification!==null" >
								<view class="text"
				...
				<view class="info_box" style="padding-bottom: 0;">
					...
					<view class="order_foot">
						<view class="label">
							...
							<view class="txt">¥{{orderDetail.distributionFee}}</view>
						</view>
					</view>
				</view>
			</view>
				...
				<view class="info_box">
					<view class="label">
						...
						<view class="txt">
							...
							<span v-else-if="orderDetail.orderStatus==8">退款中</span>
		...
		<view class="footer box_shadow">
			<view class="label">
				...
				<view v-else-if="orderDetail.orderStatus==8" class="button" style="color: #da5000;">退款中</view>
			</view>
		</view>
	</view>
</template>
